...
cl = LINETCR.LINE()
cl.login(token="Eqj7cEa5s8NhgFRyUJSc.UBhojWihs3C4rkQecNQvta.u0Ciz5xIuB+gb2zFtx8HC+H4V8dQMjsZjf9JBbrp4iQ=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Equ6IJKvDRkppGOzOae9.4omhy5jiKdbgCSos2idloq.q6dHWhahWu5uf4OeGOXcTmB0E0ER1RG/mjs0bHYDJlo=")
ki.loginResult()
KAC=[cl,ki]
...
Bots = [mid,kimid,"ub9b1ce2702074b773844aa840a7a954c"]
admsa = "ub9b1ce2702074b773844aa840a7a954c"
admin = "ub9b1ce2702074b773844aa840a7a954c"
